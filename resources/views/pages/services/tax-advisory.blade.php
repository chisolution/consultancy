...
<section class="py-20 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-900 mb-4">{{ __('services.tax_advisory.consultation.title') }}</h2>
            <p class="text-xl text-gray-600">
                {{ __('services.tax_advisory.consultation.subtitle') }}
            </p>
        </div>
        ...
        <div class="bg-gray-50 rounded-2xl p-8">
            <form id="tax-advisory-form" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @csrf
                <input type="hidden" name="service_type" value="tax_advisory">
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">{{ __('common.form.name') }}</label>
                    <input type="text" id="name" name="name" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-500 focus:border-accent-500">
                </div>
                ...
                <div class="md:col-span-2">
                    <label for="tax_service" class="block text-sm font-medium text-gray-700 mb-2">{{ __('services.tax_advisory.form.service_needed') }}</label>
                    <select id="tax_service" name="tax_service" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-500 focus:border-accent-500">
                        <option value="">{{ __('services.tax_advisory.form.select_service') }}</option>
                        <option value="vat_services">{{ __('services.tax_advisory.services.vat.title') }}</option>
                        <option value="income_tax">{{ __('services.tax_advisory.services.income_tax.title') }}</option>
                        <option value="tax_planning">{{ __('services.tax_advisory.services.tax_planning.title') }}</option>
                        <option value="compliance">{{ __('services.tax_advisory.services.compliance.title') }}</option>
                        <option value="full_service">{{ __('services.tax_advisory.form.full_service') }}</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2">
                    <button type="submit" id="submit-btn" class="w-full bg-accent-600 hover:bg-accent-700 text-white py-4 px-8 rounded-lg font-semibold text-lg transition-colors duration-200">
                        <span id="submit-text">{{ __('services.tax_advisory.form.submit') }}</span>
