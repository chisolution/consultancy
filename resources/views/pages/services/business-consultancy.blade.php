...
<section id="consultation" class="py-16 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gray-50 rounded-2xl p-8">
            <form id="business-consultancy-form" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @csrf
                <input type="hidden" name="service_type" value="business_consultancy">
                <div>
                ...
                <div class="md:col-span-2">
                    <button type="submit" id="submit-btn" class="w-full bg-primary-600 hover:bg-primary-700 text-white py-4 px-8 rounded-lg font-semibold text-lg transition-colors duration-200">
                        <span id="submit-text">{{ __('services.business_consultancy.form.submit') }}</span>
