                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <a href="#" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                                ...
                                <div>
                                    <div class="font-medium text-gray-900">View All Inquiries</div>
                                    <div class="text-sm text-gray-600">Manage contact and service inquiries</div>
                                </div>
                            </a>
                            ...
                            <a href="#" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-600">Add, edit, or remove users</div>
                                </div>
                            </a>
