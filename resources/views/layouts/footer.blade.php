    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center mb-4">
                    ...
                    <span class="ml-3 text-xl font-bold">Professional Consultancy</span>
                </div>
                <p class="text-gray-300 mb-4">
                    Expert business consultancy, accounting, and financial advisory services from Kigali, Rwanda, serving clients globally through specialist partnerships.
                </p>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm">
                © {{ date('Y') }} Professional Consultancy Rwanda. All rights reserved.
            </p>
