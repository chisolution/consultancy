...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>@yield('title', config('app.name', 'Professional Consultancy Rwanda'))</title>
    <meta name="description" content="@yield('description', 'Professional business consultancy, accounting, and financial advisory services from Rwanda serving clients globally.')">
    <meta name="keywords" content="@yield('keywords', 'business consultancy Rwanda, accounting services, tax advisory, financial planning')">

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="@yield('title', config('app.name'))">
    <meta property="og:description" content="@yield('description', 'Professional business consultancy services from Rwanda')">
    ...
    <meta name="twitter:description" content="@yield('description', 'Professional business consultancy services from Rwanda')">
    ...
    @foreach(\App\Helpers\LocaleHelper::getSupportedLocales() as $locale => $name)
        @if($locale !== \App\Helpers\LocaleHelper::getCurrentLocale())
            <link rel="alternate" hreflang="{{ $locale }}" href="{{ \App\Helpers\LocaleHelper::switchLanguageUrl($locale) }}">
        @endif
    @endforeach
