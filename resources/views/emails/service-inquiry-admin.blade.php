...
<head>
    ...
    <title>New Service Inquiry - {{ $inquiry->reference }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <p>Service: <strong>{{ $inquiry->service_display_name }}</strong></p>
    ...
    <div class="footer">
        <p><strong>Action Required:</strong> Please respond to this service inquiry within 24 hours.</p>
        <p>You can manage this inquiry in the admin dashboard.</p>
        <p>This email was sent automatically from the consultancy website service form.</p>
    </div>
</body>
</html>
